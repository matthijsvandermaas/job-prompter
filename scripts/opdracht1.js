...
//1d
const salesJobs = departments.sales.jobs;
let jobDescription = "";

for (let i = 0; i < salesJobs.length; i++) {
    if (salesJobs[i].title === "Verkoopmanager") {
        jobDescription = salesJobs[i].description;
        break;
    }
}

console.log("Sales is een uitdagende afdeling om te werken als Verkoopmanager. " + jobDescription);
