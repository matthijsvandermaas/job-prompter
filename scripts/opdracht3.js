...
//3a
const userInput = prompt('Je koos marketing. Over welke functie wil je meer weten? Voer een getal tussen 0 en 3 in.\n0: ' + departments.marketing[0].title + '\n1: ' + departments.marketing[1].title + '\n2: ' + departments.marketing[2].title + '\n3: ' + departments.marketing[3].title);
console.log(userInput);

//3b
const userInput = prompt('Je koos marketing. Over welke functie wil je meer weten? Voer een getal tussen 0 en 3 in.\n0: ' + departments.marketing[0].title + '\n1: ' + departments.marketing[1].title + '\n2: ' + departments.marketing[2].title + '\n3: ' + departments.marketing[3].title);
const selectedFunction = parseInt(userInput);
if (selectedFunction >= 0 && selectedFunction <= 3) {
    console.log(`Je koos ${departments.marketing[selectedFunction].title}. Een uitdagende rol! ${departments.marketing[selectedFunction].description}`);
} else {
