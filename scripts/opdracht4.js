...
const userInputFunction = prompt(`Je koos ${userInputDepartment}. Over welke functie wil je meer weten? Voer een getal tussen 0 en 3 in.\n0: ${departments[userInputDepartment][0].title}\n1: ${departments[userInputDepartment][1].title}\n2: ${departments[userInputDepartment][2].title}\n3: ${departments[userInputDepartment][3].title}`);
const selectedFunction = parseInt(userInputFunction);
if (selectedFunction >= 0 && selectedFunction <= 3) {
    console.log(`Je koos ${departments[userInputDepartment][selectedFunction].title}. Een uitdagende rol! ${departments[userInputDepartment][selectedFunction].description}`);
} else {
